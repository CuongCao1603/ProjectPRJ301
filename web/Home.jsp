            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarsExampleDefault">
                    <ul class="navbar-nav m-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#">Hello Cuong Cao</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <form action="search" method="post" class="form-inline my-2 my-lg-0">
                        <div class="input-group input-group-sm">
                            ...
                            <div class="input-group-append">
                                <button type="submit" class="btn-secondary btn-number">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-lg-4 col-xl-3">
                        ...
                        <p class="mb-0">
                            Le Lorem Ipsum est simplement du faux texte employee dans la composition et la mise en page avant impression.
                        </p>
                    </div>
